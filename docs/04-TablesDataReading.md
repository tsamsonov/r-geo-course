...
![](04-TablesDataReading_files/figure-epub3/unnamed-chunk-2-1.png)<!-- -->
...
![](04-TablesDataReading_files/figure-epub3/unnamed-chunk-5-1.png)<!-- -->
...
View(caspian)
```
![](04-TablesDataReading_files/figure-epub3/unnamed-chunk-17-1.png)<!-- -->
...
View(sewage)
```
![](04-TablesDataReading_files/figure-epub3/unnamed-chunk-22-1.png)<!-- -->
...
View(sewage)
```
![](04-TablesDataReading_files/figure-epub3/unnamed-chunk-25-1.png)<!-- -->
...
```
![](04-TablesDataReading_files/figure-epub3/unnamed-chunk-30-1.png)<!-- -->
...
View(okruga)
```
![](04-TablesDataReading_files/figure-epub3/unnamed-chunk-33-1.png)<!-- -->
...
View(neokruga)
```
![](04-TablesDataReading_files/figure-epub3/unnamed-chunk-36-1.png)<!-- -->
...
View(neokruga)
```
![](04-TablesDataReading_files/figure-epub3/unnamed-chunk-39-1.png)<!-- -->
...
View(tab)
```
![](04-TablesDataReading_files/figure-epub3/unnamed-chunk-42-1.png)<!-- -->
