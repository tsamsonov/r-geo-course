...
View(tab)
```
![](04-TablesDataReading_files/figure-epub3/unnamed-chunk-6-1.png)<!-- -->
...
View(head(sewage, 3))
```
![](04-TablesDataReading_files/figure-epub3/unnamed-chunk-8-1.png)<!-- -->
...
View(caspian)
```
![](04-TablesDataReading_files/figure-epub3/unnamed-chunk-16-1.png)<!-- -->
