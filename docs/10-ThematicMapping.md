...
View(reg)
```
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-3-1.png)<!-- -->
...
View(tab)
```
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-6-1.png)<!-- -->
...
head(tab)
## # A tibble: 6 x 11
##     FID Region `1959` `1970` `1979` `1989` `2002` `2010` `2013` `2014`
##   <dbl> <chr>   <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>
## 1    29 Астра…  0.702  0.867  0.916  0.998   1.01   1.01   1.01   1.02
## 2    18 Белго…  1.23   1.26   1.30   1.38    1.51   1.53   1.54   1.54
## 3    22 Брянс…  1.55   1.58   1.51   1.47    1.38   1.28   1.25   1.24
## 4     9 Влади…  1.40   1.51   1.58   1.65    1.52   1.44   1.42   1.41
## 5    27 Волго…  1.85   2.32   2.48   2.59    2.70   2.61   2.58   2.57
## 6    10 Ворон…  2.37   2.53   2.48   2.47    2.38   2.34   2.33   2.33
## # ... with 1 more variable: `2015` <dbl>
```
...
View(reg)
```
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-10-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-11-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-12-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-13-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-14-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-15-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-16-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-17-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-18-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-18-2.png)<!-- -->
...
##      X2015                  geometry
## 1 3.270203 POINT (44.60672 56.31283)
## 2 1.355618 POINT (44.62895 53.18403)
## 3 0.687435 POINT (47.93081 56.57916)
## 4 0.808888 POINT (44.44885 54.36621)
## 5 3.855037 POINT (50.90853 55.35318)
## 6 3.212676  POINT (50.4624 53.28303)
```
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-20-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-21-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-23-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-26-1.png)<!-- -->
...
## Reading layer `Lakes' from data source `/Users/tsamsonov/GitHub/r-geo-course/data/Lakes.gpkg' using driver `GPKG'
...
## Reading layer `Rivers' from data source `/Users/tsamsonov/GitHub/r-geo-course/data/Rivers.gpkg' using driver `GPKG'
...
## Reading layer `Cities' from data source `/Users/tsamsonov/GitHub/r-geo-course/data/Cities.gpkg' using driver `GPKG'
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-29-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-30-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-31-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-32-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/basetemp-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-33-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-34-1.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-34-2.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-34-3.png)<!-- -->![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-34-4.png)<!-- -->![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-34-5.png)<!-- -->![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-34-6.png)<!-- -->![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-34-7.png)<!-- -->![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-34-8.png)<!-- -->
...
![](10-ThematicMapping_files/figure-epub3/unnamed-chunk-35-1.png)<!-- -->
