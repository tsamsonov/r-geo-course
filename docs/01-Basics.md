...
## [1] -1.06966589 -0.06039884  0.77706125  1.26925423  1.56810851
(b = 2 * a) # переменная a доступна, ее можно использовать и далее для вычислений
## [1] -2.1393318 -0.1207977  1.5541225  2.5385085  3.1362170
```
...
> Подобное поведение называется _copy-on-modify_. Оно позволяет экономить на вычислениях в случае, когда копия и оригинал остаются неизменными. Аналогичное правило применяется когда вы копируете структуры данных, такие как векторы, списки и фреймы данных (см. Главу \@ref(data_structures)). Более подробно см. параграф 2.3 в [@wickham:2019].
