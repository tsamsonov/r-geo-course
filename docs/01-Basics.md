...
## [1]  0.50897389  0.70106257  0.04036892 -0.48918958 -1.12104836
(b = 2 * a) # переменная a доступна, ее можно использовать и далее для вычислений
## [1]  1.01794778  1.40212514  0.08073784 -0.97837916 -2.24209672
```
...
1. Запишите условие неравенства чисел `a` и `b`, не используя операторы `!=`, `==` и `!`.
