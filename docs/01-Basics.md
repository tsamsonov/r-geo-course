...
## [1]  0.23237446  0.09328214 -1.39601851 -0.82197064 -0.25346306
(b = 2 * a) # переменная a доступна, ее можно использовать и далее для вычислений
## [1]  0.4647489  0.1865643 -2.7920370 -1.6439413 -0.5069261
```
