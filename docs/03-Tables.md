...
##  7 Ивановская обла…    2.1    1.6    2.2    3.1    4      4.8    4.6    4.2
##  8 Калужская облас…    2.2    2.3    2.3    2.5    2.4    3.1    3.2    3.2
##  9 Костромская обл…   10     25.2   11     11.8   15.3   13.6   15.1   16.4
...
##   Region            `2005` `2010` `2011` `2012` `2013` `2014` `2015` `2016`
##   <chr>              <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>
## 1 Российская Федер…  812.   812.   860    842.   872.   863    803.   840. 
## 2 Центральный феде…   52.6   62.7   60.9   60.3   70.9   71.2   72.6   77  
## 3 Белгородская обл…    0.4    0.1    0.3    0.3    0.4    0.4    0.2    0.2
## 4 Брянская область     2.9    2.8    3      3.2    3.5    3.3    3.1    3  
## 5 Владимирская обл…    4.4    5.3    5.7    6      7.1    5.9    6      4.9
## 6 Воронежская обла…    1.1    1.1    1.8    3      2.7    2.7    2.6    2.3
tail(reforest)
## # A tibble: 6 x 9
##   Region            `2005` `2010` `2011` `2012` `2013` `2014` `2015` `2016`
##   <chr>              <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>
...
## 3 Магаданская обла…    2.7    2.6    2.6    2.8    3      2.5    0.4   NA  
## 4 Сахалинская обла…   13.1   12.7   12.5    4.6    4.7    4.9    4.7    4.1
## 5 Еврейская автоно…    2.9   NA      2.6    2.5    2.3   NA     NA      2.4
## 6 Чукотский автоно…    0.3   NA     NA     NA     NA     NA     NA     NA
```
...
```
В некоторых случаях бывает удобно распределить переменную по нескольким колонкам. В частности, это может быть удобно, если нам надо вычислить разности между годами. Для этого используем `spread()`:
...
##  2 Амурская область   33.3   29.8   32.2   33.6   35.5   37.7   28.5   27.7
##  3 Архангельская о…   42.6   39.4   48.5   48.8   52.7   60.7   57.6   63.5
##  4 Астраханская об…    0.1    0.1    0      0.1    0.1    0.1    0.1    0  
##  5 Белгородская об…    0.4    0.1    0.3    0.3    0.4    0.4    0.2    0.2
##  6 Брянская область    2.9    2.8    3      3.2    3.5    3.3    3.1    3  
##  7 Владимирская об…    4.4    5.3    5.7    6      7.1    5.9    6      4.9
##  8 Волгоградская о…    1.6    1.8    2      1.3    1.1    1.2    0.9    0.9
##  9 Вологодская обл…   25.6   32.3   44.2   43.3   43.6   44.8   49     52  
## 10 Воронежская обл…    1.1    1.1    1.8    3      2.7    2.7    2.6    2.3
## # … with 79 more rows
```
...
##    <chr>              <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl> <dbl>
##  1 Белгородская обл…   30.4   39.6   27.7   37.4   34.1   45.6   30.4    60
##  2 Брянская область   614.   616.   824.   850.   793.   739.   750.     27
##  3 Владимирская обл… 1078   1335   1236   1142   1165   1272   1252      20
##  4 Воронежская обла…   73.6   69.5   68.6   47.9   81.1   86.6   53.5    58
##  5 Ивановская облас…  130.   140.   200.   199.   231.   326.   421.     38
##  6 Калужская область  274.   244.   192.   198.   183    145.   204      44
##  7 Костромская обла… 3000   3332   2797   2692   2564   2186   2515      14
##  8 Курская область     22.8   55.4   49.7   50.1   65.9   74.6   80.7    55
##  9 Липецкая область   163.   139     49.7   42.6   50.1   73.1   87.8    53
## 10 Московская облас…  126.   265.   299.   108.    15.6   NA     NA      74
## # … with 65 more rows
```
...
1. Как работают функции `gather()` и `spread()`?
