...
View(tab)
```
![](03-Tables_files/figure-epub3/unnamed-chunk-11-1.png)<!-- -->
...
View(head(sewage, 3))
```
![](03-Tables_files/figure-epub3/unnamed-chunk-13-1.png)<!-- -->
...
View(caspian)
```
![](03-Tables_files/figure-epub3/unnamed-chunk-21-1.png)<!-- -->
...
View(okruga)
```
![](03-Tables_files/figure-epub3/unnamed-chunk-30-1.png)<!-- -->
...
View(neokruga)
```
![](03-Tables_files/figure-epub3/unnamed-chunk-33-1.png)<!-- -->
...
View(neokruga)
```
![](03-Tables_files/figure-epub3/unnamed-chunk-36-1.png)<!-- -->
...
```
![](03-Tables_files/figure-epub3/unnamed-chunk-41-1.png)<!-- -->
...
View(tab)
```
![](03-Tables_files/figure-epub3/unnamed-chunk-44-1.png)<!-- -->
...
## Обработка таблиц в dplyr {#dplyr}
