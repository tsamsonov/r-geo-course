...
::: {.rmdwarning}
[__Внимание:__ разделы курса по пространственной статистике c октября 2021 г. переехали в отдельный репозиторий:]{color="orangered"} https://tsamsonov.github.io/r-spatstat-course
:::
