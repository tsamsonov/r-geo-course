...
## Time difference of 1571738269 secs
```
...
## [1] 2019-10-22 12:57:48 MSK--2015-01-22 12:57:48 MSK
as.period(int, 'days')
## [1] "-1734d 0H 0M -0.105149030685425S"
as.duration(int)
## [1] "149817600.105149s (~4.75 years)"
```
