...
### Создание и преобразование временных данных {#circular_time_lubridate}
...
## Time difference of 1571734546 secs
```
...
## [1] 2019-10-22 11:55:46 MSK--2015-01-22 11:55:46 MSK
as.period(int, 'days')
## [1] "-1734d 0H 0M -0.115594863891602S"
as.duration(int)
## [1] "149817600.115595s (~4.75 years)"
```
