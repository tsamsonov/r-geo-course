...
## Time difference of 1571739431 secs
```
...
## [1] 2019-10-22 13:17:10 MSK--2015-01-22 13:17:10 MSK
as.period(int, 'days')
## [1] "-1734d 0H 0M -0.105333089828491S"
as.duration(int)
## [1] "149817600.105333s (~4.75 years)"
```
