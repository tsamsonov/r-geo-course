...
## Time difference of 1571850036 secs
```
...
## [1] 2019-10-23 20:00:36 MSK--2015-01-23 20:00:36 MSK
as.period(int, 'days')
## [1] "-1734d 0H 0M -0.109624147415161S"
as.duration(int)
## [1] "149817600.109624s (~4.75 years)"
```
...
<img src="08-StatisticsCircular_files/figure-html/unnamed-chunk-26-1.png" width="672" />
...
<img src="08-StatisticsCircular_files/figure-html/unnamed-chunk-28-1.png" width="672" />
...
Подобные несовершенства временных рядов важно выявить на самых ранних стадиях анализа данных. Рассмотрим, как эту задачу можно решить средствами R. В качестве источника данных будем использовать данные гидропоста на пороге Паялка (р. Умба, Мурманская область)^[Данные предоставлены кафедрой гидрологии суши Географического факультета МГУ имени М.В.Ломоносова]:
