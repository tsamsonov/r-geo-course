...
distances(x, y)
## [1] 0.9112542 1.3153220 3.0479748
```
...
## # … with 8 more variables: business <dbl>, minerals <dbl>, manufact <dbl>,
## #   engaswat <dbl>, construct <dbl>, apart <dbl>, retail <dbl>,
## #   invest <dbl>
```
...
1. Создайте на основе данных сайта [pogodaiklimat](http://www.pogodaiklimat.ru/climate/27612.htm) таблицу с повторяемостью различных направлений ветра. Не преобразовывая структуру данных, вычислите с помощью `lapply()` преобладающее направление для каждого месяца. Представьте результат как фрейм данных.
