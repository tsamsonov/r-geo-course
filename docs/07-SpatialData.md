...
![](07-SpatialData_files/figure-epub3/unnamed-chunk-38-1.png)<!-- -->
...
![](07-SpatialData_files/figure-epub3/unnamed-chunk-40-1.png)<!-- -->
...
![](07-SpatialData_files/figure-epub3/unnamed-chunk-43-1.png)<!-- -->
...
![](07-SpatialData_files/figure-epub3/unnamed-chunk-45-1.png)<!-- -->

#### Полигонизация и добавление узлов {#sf_polygonize}

__Полигонизация__ --- это процесс преобразования мультилинии в полигон(ы). В процессе полигонизации находятся все замкнутые области, образуемые компонентами мультилинии. Для того чтобы такие области образовались, линии должны пересекаться или касаться друг друга. Операция полигонизации требует также, чтобы в местах пересечения или касания двух линий они имели общие (совпадающие) точки. Если таких точек нет, их можно создать с помощью операции __добавления узлов__. Операция добавления узлов бывает также нужна в тех случаях, когда линии представляют собой граф дорожной сети: чтобы можно было поворачивать на перекрестке, обе линии должны иметь точку в месте их пересечения.
...
![](07-SpatialData_files/figure-epub3/unnamed-chunk-46-1.png)<!-- -->
...
```
Операция завершилась возвратом пустой геометрической коллекции, то есть программа не смогла выделить замкнутые области. Это произошло по причине того, что у линий нет общих точек в местах пересечения. Эти точки можно добавить, используя функцию `st_node()`:
...
![](07-SpatialData_files/figure-epub3/unnamed-chunk-48-1.png)<!-- -->
...
![](07-SpatialData_files/figure-epub3/unnamed-chunk-50-1.png)<!-- -->
